...
------------------------
 ...
 - L'affichage des quizz est entamé mais pas achevé, pour la pagination nous affichons le numero de la page qui suit, on a la zone de tri dont on perd le valeur et aui faisait buguer le programme.
 - Le formulaire recherche fonctionne à moitié, on peut recuuperer la valeur saisie par l'utilisateur en cliquant sur le bouton Recherche mais on la perd quand on veut l'afficher par contre on peut supprimer la saisi a l'aide de la crois dans la barre de recherche
