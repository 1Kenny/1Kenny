...
$title = "Profile de " . $_SESSION['username'];
...
function get_extension($nom) 
{
	...
	$dest_dossier = '../public/images/'; //nom du dossier ou vous allez stocké vos images
	$dest_fichier="";
	...
	if(@$erreurs[0]!="")
	{
		echo " un probleme est survenu lors de l'upload de l'image";
